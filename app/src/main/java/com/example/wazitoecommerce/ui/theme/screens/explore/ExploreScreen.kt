    ...
    Column(modifier = Modifier.fillMaxSize()){
        ...
        Scaffold(
            topBar = {
                //TopAppBar
                TopAppBar(
                    title = { Text(text = "AuctionAlly", color = Color.White, fontWeight = FontWeight.ExtraBold) },
                    colors = TopAppBarDefaults.mediumTopAppBarColors(Color.Transparent),
                    navigationIcon = {
                        IconButton(onClick = {navController.navigate(LOGIN_URL)}) {
                            Icon(imageVector = Icons.Default.Info, contentDescription = "back",tint = Color.Black)
            ...
            content = @Composable{
                ...
                Column (modifier = Modifier.verticalScroll(rememberScrollState())){
                    ...
                    OutlinedTextField(
                        ...
                        placeholder = { Text(text = "Search & auction gadgets")},
